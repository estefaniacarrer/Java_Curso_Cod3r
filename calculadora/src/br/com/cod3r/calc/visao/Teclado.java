...
public class Teclado extends JPanel implements ActionListener{
	...
	public Teclado() {
		...
		GridBagLayout layout = new GridBagLayout(); // organizar linhas e colunas
		GridBagConstraints c = new GridBagConstraints();
		
		setLayout(layout);
		 
		
		// para os elementos terem o mesmo espaço
		c.weightx = 1;
		c.weighty = 1;
		c.fill = GridBagConstraints.BOTH;
		
		//setLayout(new GridLayout(5, 4)); distribui os botoes de tamanhos iguais
		// utilizamos outra forma pois o 0 irá ocupar 2 espaços.
		
		//LINHA 1
		c.gridwidth = 2;  // ocupar 3 espaços
